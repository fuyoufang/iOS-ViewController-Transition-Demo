...
@objc protocol ContainerViewControllerDelegate{
    // Swift don't support protocol object in protocol now.
    // if you want to support interactive transition, set SDEContainerViewController's containerTransitionDelegate to class 'SDEContainerViewControllerDelegate', not protocol 'ContainerViewControllerDelegate'
    
    //var interactionController: UIViewControllerInteractiveTransitioning?
    
    func containerController(_ containerController: SDEContainerViewController,
                             animationControllerForTransitionFromViewController fromVC: UIViewController,
                             toViewController toVC: UIViewController)
    -> UIViewControllerAnimatedTransitioning?
    
    
    @objc optional func containerController(_ containerController: SDEContainerViewController,
                                            interactionControllerForAnimation animationController: UIViewControllerAnimatedTransitioning)
...
class SDEContainerViewControllerDelegate: NSObject, ContainerViewControllerDelegate {
    ...
    func containerController(_ containerController: SDEContainerViewController,
        ...
        let fromIndex = containerController.viewControllers!.firstIndex(of: fromVC)!
        let toIndex = containerController.viewControllers!.firstIndex(of: toVC)!
